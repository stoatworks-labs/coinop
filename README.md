...
**[v1.0.6](https://github.com/stoatworks-labs/coinop/releases/tag/v1.0.6)** — prebuilt for macOS and Windows. Pick your platform:
...
| Build | Download | Size |
| --- | --- | --- |
| Universal (Apple Silicon + Intel) · .dmg disk image | [`coinop-1.0.6-macos-universal.dmg`](https://github.com/stoatworks-labs/coinop/releases/download/v1.0.6/coinop-1.0.6-macos-universal.dmg) | 719 KB |
| Universal (Apple Silicon + Intel) · .zip archive | [`coinop-macos-universal.zip`](https://github.com/stoatworks-labs/coinop/releases/latest/download/coinop-macos-universal.zip) | 652 KB |
...
| Build | Download | Size |
| --- | --- | --- |
| x64 · .exe installer | [`coinop-1.0.6-windows-x86_64-setup.exe`](https://github.com/stoatworks-labs/coinop/releases/download/v1.0.6/coinop-1.0.6-windows-x86_64-setup.exe) | 275 KB |
| x64 · .zip archive | [`coinop-windows-x86_64.zip`](https://github.com/stoatworks-labs/coinop/releases/latest/download/coinop-windows-x86_64.zip) | 340 KB |
