...
**[v1.0.2](https://github.com/stoatworks-labs/coinop/releases/tag/v1.0.2)** — prebuilt for macOS and Windows. Pick your platform:
...
| Build | Download | Size |
| --- | --- | --- |
| Universal (Apple Silicon + Intel) · .dmg disk image | [`coinop-1.0.2-macos-universal.dmg`](https://github.com/stoatworks-labs/coinop/releases/download/v1.0.2/coinop-1.0.2-macos-universal.dmg) | 1.0 MB |
...
| Build | Download | Size |
| --- | --- | --- |
| x64 · .exe installer | [`coinop-1.0.2-windows-x86_64-setup.exe`](https://github.com/stoatworks-labs/coinop/releases/download/v1.0.2/coinop-1.0.2-windows-x86_64-setup.exe) | 270 KB |
