/*
 * Stoatworks Labs - About window data for Coinop.
 *
...
{
    inline constexpr auto name = "Coinop";
    inline constexpr auto slug = "coinop";
    inline constexpr auto hook = "Fourteen arcade games as a Resolume plugin";
